// Generated from C:/Users/ArneL/git/glsl-transformation-lib/src/main/antlr/GLSLLexer.g4 by ANTLR 4.13.1
...
public class GLSLLexer extends Lexer {
	...
	public static final int
		...
		READONLY=113, RESTRICT=114, RETURN=115, SAMPLE=116, SAMPLER1D=117, SAMPLER1DARRAY=118, 
		SAMPLER1DARRAYSHADOW=119, SAMPLER1DSHADOW=120, SAMPLER2D=121, SAMPLER2DARRAY=122, 
		SAMPLER2DARRAYSHADOW=123, SAMPLER2DMS=124, SAMPLER2DMSARRAY=125, SAMPLER2DRECT=126, 
		SAMPLER2DRECTSHADOW=127, SAMPLER2DSHADOW=128, SAMPLER3D=129, SAMPLERBUFFER=130, 
		SAMPLERCUBE=131, SAMPLERCUBEARRAY=132, SAMPLERCUBEARRAYSHADOW=133, SAMPLERCUBESHADOW=134, 
		SAMPLERSHADOW=135, SHARED=136, SMOOTH=137, STRUCT=138, SUBPASSINPUT=139, 
		SUBPASSINPUTMS=140, SUBROUTINE=141, SWITCH=142, TEXTURE1D=143, TEXTURE1DARRAY=144, 
		TEXTURE2D=145, TEXTURE2DARRAY=146, TEXTURE2DMS=147, TEXTURE2DMSARRAY=148, 
		TEXTURE2DRECT=149, TEXTURE3D=150, TEXTUREBUFFER=151, TEXTURECUBE=152, 
		TEXTURECUBEARRAY=153, TRUE=154, UIMAGE1D=155, UIMAGE1DARRAY=156, UIMAGE2D=157, 
		UIMAGE2DARRAY=158, UIMAGE2DMS=159, UIMAGE2DMSARRAY=160, UIMAGE2DRECT=161, 
		UIMAGE3D=162, UIMAGEBUFFER=163, UIMAGECUBE=164, UIMAGECUBEARRAY=165, UINT=166, 
		UNIFORM=167, USAMPLER1D=168, USAMPLER1DARRAY=169, USAMPLER2D=170, USAMPLER2DARRAY=171, 
		USAMPLER2DMS=172, USAMPLER2DMSARRAY=173, USAMPLER2DRECT=174, USAMPLER3D=175, 
		USAMPLERBUFFER=176, USAMPLERCUBE=177, USAMPLERCUBEARRAY=178, USUBPASSINPUT=179, 
		USUBPASSINPUTMS=180, UTEXTURE1D=181, UTEXTURE1DARRAY=182, UTEXTURE2D=183, 
		UTEXTURE2DARRAY=184, UTEXTURE2DMS=185, UTEXTURE2DMSARRAY=186, UTEXTURE2DRECT=187, 
		UTEXTURE3D=188, UTEXTUREBUFFER=189, UTEXTURECUBE=190, UTEXTURECUBEARRAY=191, 
		UVEC2=192, UVEC3=193, UVEC4=194, VARYING=195, VEC2=196, VEC3=197, VEC4=198, 
		VOID=199, VOLATILE=200, WHILE=201, WRITEONLY=202, ADD_ASSIGN=203, AMPERSAND=204, 
		AND_ASSIGN=205, AND_OP=206, BANG=207, CARET=208, COLON=209, COMMA=210, 
		DASH=211, DEC_OP=212, DIV_ASSIGN=213, DOT=214, EQ_OP=215, EQUAL=216, GE_OP=217, 
		INC_OP=218, LE_OP=219, LEFT_ANGLE=220, LEFT_ASSIGN=221, LEFT_BRACE=222, 
		LEFT_BRACKET=223, LEFT_OP=224, LEFT_PAREN=225, MOD_ASSIGN=226, MUL_ASSIGN=227, 
		NE_OP=228, NUMBER_SIGN=229, OR_ASSIGN=230, OR_OP=231, PERCENT=232, PLUS=233, 
		QUESTION=234, RIGHT_ANGLE=235, RIGHT_ASSIGN=236, RIGHT_BRACE=237, RIGHT_BRACKET=238, 
		RIGHT_OP=239, RIGHT_PAREN=240, SEMICOLON=241, SLASH=242, STAR=243, SUB_ASSIGN=244, 
		TILDE=245, VERTICAL_BAR=246, XOR_ASSIGN=247, XOR_OP=248, DOUBLECONSTANT=249, 
		FLOATCONSTANT=250, INTCONSTANT=251, UINTCONSTANT=252, BLOCK_COMMENT=253, 
		LINE_COMMENT=254, LINE_CONTINUATION=255, IDENTIFIER=256, WHITE_SPACE=257, 
		DEFINE_DIRECTIVE=258, ELIF_DIRECTIVE=259, ELSE_DIRECTIVE=260, ENDIF_DIRECTIVE=261, 
		ERROR_DIRECTIVE=262, EXTENSION_DIRECTIVE=263, IF_DIRECTIVE=264, IFDEF_DIRECTIVE=265, 
		IFNDEF_DIRECTIVE=266, LINE_DIRECTIVE=267, PRAGMA_DIRECTIVE=268, UNDEF_DIRECTIVE=269, 
		VERSION_DIRECTIVE=270, SPACE_TAB_0=271, NEWLINE_0=272, MACRO_NAME=273, 
		NEWLINE_1=274, SPACE_TAB_1=275, CONSTANT_EXPRESSION=276, NEWLINE_2=277, 
		ERROR_MESSAGE=278, NEWLINE_3=279, BEHAVIOR=280, EXTENSION_NAME=281, NEWLINE_4=282, 
		SPACE_TAB_2=283, NEWLINE_5=284, MACRO_IDENTIFIER=285, NEWLINE_6=286, SPACE_TAB_3=287, 
		LINE_EXPRESSION=288, NEWLINE_7=289, MACRO_ESC_NEWLINE=290, MACRO_TEXT=291, 
		NEWLINE_8=292, DEBUG=293, NEWLINE_9=294, OFF=295, ON=296, OPTIMIZE=297, 
		SPACE_TAB_5=298, STDGL=299, PROGRAM_TEXT=300, NEWLINE_10=301, SPACE_TAB_6=302, 
		NEWLINE_11=303, NUMBER=304, PROFILE=305, SPACE_TAB_7=306;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SAMPLERCUBESHADOW", "SAMPLERSHADOW", "SHARED", "SMOOTH", "STRUCT", "SUBPASSINPUT", 
			"SUBPASSINPUTMS", "SUBROUTINE", "SWITCH", "TEXTURE1D", "TEXTURE1DARRAY", 
			"TEXTURE2D", "TEXTURE2DARRAY", "TEXTURE2DMS", "TEXTURE2DMSARRAY", "TEXTURE2DRECT", 
			"TEXTURE3D", "TEXTUREBUFFER", "TEXTURECUBE", "TEXTURECUBEARRAY", "TRUE", 
			"UIMAGE1D", "UIMAGE1DARRAY", "UIMAGE2D", "UIMAGE2DARRAY", "UIMAGE2DMS", 
			"UIMAGE2DMSARRAY", "UIMAGE2DRECT", "UIMAGE3D", "UIMAGEBUFFER", "UIMAGECUBE", 
			"UIMAGECUBEARRAY", "UINT", "UNIFORM", "USAMPLER1D", "USAMPLER1DARRAY", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "'debug'", null, "'off'", "'on'", "'optimize'", null, "'STDGL'"
		};
	}
	...
	private static final String _serializedATNSegment0 =
		...
		"\u0086=\u0088>\u008a?\u008c@\u008eA\u0090B\u0092C\u0094D\u0096E\u0098"+
		"F\u009aG\u009cH\u009eI\u00a0J\u00a2K\u00a4L\u00a6M\u00a8N\u00aaO\u00ac"+
		"P\u00aeQ\u00b0R\u00b2S\u00b4T\u00b6U\u00b8V\u00baW\u00bcX\u00beY\u00c0"+
		"Z\u00c2[\u00c4\\\u00c6]\u00c8^\u00ca_\u00cc`\u00cea\u00d0b\u00d2c\u00d4"+
		"d\u00d6e\u00d8f\u00dag\u00dch\u00dei\u00e0j\u00e2k\u00e4l\u00e6m\u00e8"+
